...
# Le programme doit ensuite afficher la table de multiplication de ce nombre pour les nombres de 1 à 10.
...
number = 1
for i in range(1, 11) :
    print(f"{start_number} x {number} = {start_number * number}")
    number +=1